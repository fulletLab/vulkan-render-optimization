...
- Prefiltered environment maps, complete shadow/material coverage, and full debug/label overlay passes remain open renderer work; Qt must not become the primary 3D renderer.

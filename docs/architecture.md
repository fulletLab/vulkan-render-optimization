...
- The bottom Profiler tab reads `RendererStats` and exposes Vulkan frame, draw, culling, CPU timing, light, and shadow counters without coupling engine runtime code to Qt.

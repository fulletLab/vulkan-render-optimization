...
- Prefiltered environment maps, complete shadow/material coverage, and fuller debug overlay coverage remain open renderer work; Qt must not become the primary 3D renderer.
